  ...
  test("returns oriented, non-blocked, non-self candidates ordered by similarity", () => {
    const output = psql(`
      ...
      insert into public.profiles (id, app_user_id, gender, interested_in, city, religion_type, visibility) values
        ('20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'female', array['male'], '서울', '기독교', 'discoverable'),
        ('20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'male', array['female'], '서울', '기독교', 'discoverable'),
        ('20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'male', array['female'], '서울', '기독교', 'discoverable'),
        ('20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', 'male', array['female'], '서울', '기독교', 'discoverable'),
        ('20000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000005', 'female', array['male'], '서울', '기독교', 'discoverable'),
        ('20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000006', 'male', array['female'], '서울', '기독교', 'private');
